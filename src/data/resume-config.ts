...
export const resumeConfig: ResumeConfig = {
  ...
  seo: {
    ...
    description: 'CV interactif bilingue de Jordan Wakelam-Surena, professionnel informatique polyvalent spécialisé en développement et intégration.',
  },
  languages: {
    default: 'fr',
    available: ['fr', 'en'],
  ...
  contact: [
    { type: 'linkedin', label: 'Jordan Wakelam', href: 'https://linkedin.com/in/jordan-wakelam' },
    { type: 'email', label: 'contact@jordan-wakelam.fr' },
    { type: 'phone', label: '+33 6 41 16 23 13' },
    { type: 'location', label: 'Essonne, France' },
    { type: 'website', label: 'jordan-wakelam.fr', href: 'https://jordan-wakelam.fr' },
  ],
  skills: [
    {
    ...
    },
    {
      ...
      type: 'text',
      items: [
        { name: { fr: 'Rigueur analytique, approche structurée et logique', en: 'Analytical rigor, structured and logical approach' } },
        { name: { fr: 'Résolution d\'incidents et diagnostic rapide', en: 'Incident resolution and rapid diagnosis' } },
        { name: { fr: 'Apprentissage rapide des nouvelles technologies', en: 'Quick learning of new technologies' } },
      ],
    },
    {
      ...
      type: 'text',
      items: [
        { name: { fr: 'Autonomie, Adaptabilité, Capacité pédagogique', en: 'Autonomy, Adaptability, Teaching skills' } },
      ],
    },
    {
  ...
  experiences: [
    {
      ...
      role: { fr: 'Développeur Web polyvalent / Coordinateur technique', en: 'Versatile Web Developer / Technical Coordinator' },
    ...
    },
    {
      ...
      role: { fr: 'Développeur Web intégrateur', en: 'Web Integrator Developer' },
      type: { fr: 'CDD', en: 'Fixed-term' },
    ...
    },
    {
      ...
      role: { fr: 'Chef de patrouille appui mouvement', en: 'Movement Support Patrol Leader' },
  ...
  education: [
    {
      ...
      degree: { fr: 'Licence professionnelle en informatique - Web, Mobile et Business Intelligence', en: 'Professional Bachelor in IT - Web, Mobile & Business Intelligence' },
      period: '2024 - 2025',
    },
    {
      school: { fr: 'CMFP, Fontenay-le-Comte', en: 'CMFP, Fontenay-le-Comte' },
      degree: { fr: 'Titre professionnel niveau 5 - Développeur Web et Web Mobile', en: 'Professional Title Level 5 - Web & Mobile Developer' },
      period: '2023 - 2024',
    },
  ],
  projects: [],
  hobbies: [
    {
      ...
      details: [
        { fr: 'Réparation et restauration d\'objets', en: 'Repair and restoration of objects' },
      ],
    },
    {
      title: { fr: 'Dessin', en: 'Drawing' },
      details: [
        { fr: 'Supports traditionnels et numériques', en: 'Traditional and digital media' },
      ],
    },
    {
